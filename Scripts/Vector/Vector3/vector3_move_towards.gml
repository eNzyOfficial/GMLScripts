...
var a = vector3_subtract(c, t);
var magnitude = vector3_magnitude(a);
...
if (magnitude <= mdd || magnitude == 0) {
	...
	var a = vector3_add(c, a);
	result = vector(a[0] / magnitude * mdd, a[1] / magnitude * mdd, a[2] / magnitude * mdd);
}
